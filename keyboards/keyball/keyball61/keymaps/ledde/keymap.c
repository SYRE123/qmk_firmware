...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , RALT(KC_X),DRAG_SCROLL, KC_BTN1  , _______  ,                                  _______  , KC_LEFT  , KC_UP    , KC_RGHT  , _______  , KC_F12   ,
    _______  , KC_BTN2  , KC_4     , KC_BTN3  , S(KC_BTN3) ,S(KC_SCLN),                                  KC_PGUP  , KC_BTN1  , DRAG_SCROLL  , KC_BTN2  , KC_BTN3  , NK_TOGG  ,
