...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_80(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, EE_CLR, QK_BOOT, _______,
  ...
  [2] = LAYOUT_80(
    ...
    _______, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_EM9 , KC_EM10, KC_EM11, KC_EM12, KC_EM13, KC_EM14,          _______, _______,
  ...
  [3] = LAYOUT_80(
    ...
    RGB_TOG, RGB_HUD  , RGB_HUI , _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______,  _______, _______, NK_TOGG,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [3] = { ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(RGB_MOD, RGB_RMOD) },
};
#endif